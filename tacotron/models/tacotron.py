                ...
                with tf.variable_scope('inference') as scope:
                    ...
                    if post_condition:
                        ...
                        post_cbhg = CBHG(hp.cbhg_kernels, hp.cbhg_conv_channels, hp.cbhg_pool_size,
                                         ...
                                         hp.cbhg_highway_units, hp.cbhg_rnn_units,
                                         hp.batch_norm_position, is_training, name='CBHG_postnet')
            ...
            with tf.device(tf.train.replica_device_setter(ps_tasks=1, ps_device="/cpu:0",
                ...
                with tf.variable_scope('optimizer') as scope:
                    update_vars = [v for v in self.all_vars if not (
                                'inputs_embedding' in v or 'encoder_' in v)] if hp.tacotron_fine_tuning else None
